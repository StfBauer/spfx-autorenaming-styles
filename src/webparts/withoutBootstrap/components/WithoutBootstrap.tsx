...
import styles from '../WithoutBootstrap.module.scss';
import { IWithoutBootstrapWebPartProps } from '../IWithoutBootstrapWebPartProps';

export interface IWithoutBootstrapProps extends IWithoutBootstrapWebPartProps {
}

export default class WithoutBootstrap extends React.Component<IWithoutBootstrapProps, {}> {
